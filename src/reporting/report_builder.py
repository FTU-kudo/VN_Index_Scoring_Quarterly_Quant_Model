...
<style>
  ...
  * { box-sizing: border-box; transition: background-color 0.4s ease, color 0.4s ease; }
  ...
  .math-formula { font-size: 14px; font-weight: 600; font-family: 'JetBrains Mono', monospace; background: linear-gradient(135deg, rgba(59,130,246,0.08), rgba(139,92,246,0.08)); padding: 16px 20px; border-radius: 12px; border: 1px solid rgba(59,130,246,0.15); border-left: 6px solid var(--color-blue); margin-bottom: 24px; overflow-x: auto; box-shadow: 0 8px 20px -6px rgba(59,130,246,0.15); color: #1e3a8a; white-space: nowrap; }
